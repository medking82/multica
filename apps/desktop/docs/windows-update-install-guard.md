...
- Automatic checks/downloads, saved update preferences, the fork's custom release/changelog URLs and architecture-specific feeds do not change. macOS, Linux and Windows arm64 keep their existing installation path in this scoped change.
