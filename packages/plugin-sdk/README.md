...
With the `skills:read` scope, `multica.skills.list()` returns Skill ids, names,
and descriptions from this workspace. It does not expose Skill instructions
or files.
...
from the issue menu cannot use this method.
