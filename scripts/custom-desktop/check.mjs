...
if (mode !== "preflight") {
  ...
  run("pnpm", ["--filter", "@multica/views", "test", "locales/parity.test.ts", "editor/voice-input-button.test.tsx", "editor/content-editor.test.tsx", "editor/extensions/slash-command-extension.test.ts", "editor/extensions/slash-command-suggestion.test.tsx", "modals/create-issue.test.tsx", "modals/quick-create-issue.test.tsx", "chat/components/chat-input.test.tsx", "issues/components/comment-composers.test.tsx", "issues/components/comment-dictation.test.tsx"]);
